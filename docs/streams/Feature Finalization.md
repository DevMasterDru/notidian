...
- Navigator name and path filtering is synchronous; full-text matching requires an
  index-backed or asynchronous design rather than reading every note per keystroke —
  bead `Notidian-d6lk`.
