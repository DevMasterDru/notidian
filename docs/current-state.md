...
### Column Descriptions And Title-Cell Wrap
...
| Column descriptions in header tooltips and title-cell wrap | [propertyDescription.ts](../src/core/utils/contexts/propertyDescription.ts), [propertyDescription.test.ts](../src/core/utils/contexts/propertyDescription.test.ts), [ColumnHeader.tsx](../src/core/react/components/SpaceView/Contexts/TableView/ColumnHeader.tsx), and [TableView.wrap.css.test.ts](../src/core/react/components/SpaceView/Contexts/TableView/TableView.wrap.css.test.ts) |
