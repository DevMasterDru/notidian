...
- The row-number gutter width is derived from the visible row-number digit count: one-digit views are narrower than two- or three-digit views, and the drag grip overlays the gutter instead of reserving permanent width.
