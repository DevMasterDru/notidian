export const en = {
  ...
  "menu": {
    ...
    "rowDensityNormal": "Normal",
    "rowDensityCompact": "Compact",
    "subItemsDisplay": "Display",
    "subItemsNested": "Nested",
    "subItemsFlattened": "Flattened",
    "subItemsParentsOnly": "Parents only",
    "subItemsScope": "Filter scope",
    "subItemsScopeParentsAndSubItems": "Parents and sub-items",
    "subItemsScopeParents": "Parents (keep ancestors of matches)",
    "subItemsScopeSubItems": "Sub-items (keep descendants of matches)",
    ...
    "headerDisplayAdaptive": "Adaptive",
    "headerDisplayFull": "Icon + Text",
    "headerDisplayText": "Text Only",
    "headerDisplayIcon": "Icon Only",
    "dataAnchor": "Data Anchor",
    "dataAnchorAuto": "Auto",
    "dataAnchorLeft": "Left",
    "dataAnchorCenter": "Center",
    "dataAnchorRight": "Right",
    "direction": "Direction",
  ...
  "buttons": {
    ...
    "import": "Import",
    "cancel": "Cancel",
    "deletePromoteChildren": "Delete item only",
    "deleteWithSubItems": "Delete item and ${1} sub-items",
    "create": "Create",
  ...
  "labels": {
    ...
    "propertyDescriptionPlaceholder": "Describe this property (shown on hover)",
  ...
  "descriptions": {
    ...
    "deleteRowWithSubItems": "This item has ${1} sub-items. Delete only this item (its sub-items become top-level), or delete it together with all of its sub-items?",
